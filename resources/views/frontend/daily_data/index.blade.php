                        ...
                        <div class="card-body">
                            <div class="top-0 end-0 m-3">
                                <div class="bg-success text-white p-2 rounded mb-3">
                                    <strong>Average Daily Income:</strong> <span class="float-right"> Nrs.
                                        {{ $averageDailyIncome }} </span>
                                </div>
                                <div class="bg-danger text-white p-2 rounded">
                                    <strong>Average Daily Expense:</strong> <span class="float-right"> Nrs.
