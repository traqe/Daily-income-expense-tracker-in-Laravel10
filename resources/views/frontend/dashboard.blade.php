            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    ...
                    <p class="text-success text-bold ml-3">
                        <strong>Nrs. {{ number_format($balance, 2) }} </strong>
                    </p>
                    </p>
                </div>
            </div>
                        ...
                        <div class="card card-dark-blue">
                            <div class="card-body">
                                ...
                                <p class="fs-30 text-bold ml-3">
                                    <strong>Nrs. {{ number_format($income, 2) }} </strong>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                            <div class="card-body">
                                ...
                                <p class="fs-30 text-bold ml-3">
                                    <strong>Nrs. {{ number_format($expenses, 2) }} </strong>
                                </p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                                                <div class="ml-xl-6 mt-3">
                                                    ...
                                                    <h1 class="fs-30 text-success">Nrs.
                                                        {{ number_format($income - $expenses) }}</h1>
                                                </div>
                                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($dailyExpenses as $dailyExpense)
                                            <tr>
                                                ...
                                                <td>Nrs. {{ number_format($dailyExpense->total, 2) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
